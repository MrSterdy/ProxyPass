...
public class ExplodeSerializer_v113 implements BedrockPacketSerializer<ExplodePacket> {
    public static final ExplodeSerializer_v113 INSTANCE = new ExplodeSerializer_v113();
