...
public class MobEffectSerializer_v113 implements BedrockPacketSerializer<MobEffectPacket> {
    public static final MobEffectSerializer_v113 INSTANCE = new MobEffectSerializer_v113();
