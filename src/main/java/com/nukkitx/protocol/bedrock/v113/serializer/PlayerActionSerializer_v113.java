...
public class PlayerActionSerializer_v113 implements BedrockPacketSerializer<PlayerActionPacket> {
    public static final PlayerActionSerializer_v113 INSTANCE = new PlayerActionSerializer_v113();
