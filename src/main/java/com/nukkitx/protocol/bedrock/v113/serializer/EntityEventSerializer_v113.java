...
public class EntityEventSerializer_v113 implements BedrockPacketSerializer<EntityEventPacket> {
    public static final EntityEventSerializer_v113 INSTANCE = new EntityEventSerializer_v113();

    private static final InternalLogger log = InternalLoggerFactory.getInstance(EntityEventSerializer_v113.class);
