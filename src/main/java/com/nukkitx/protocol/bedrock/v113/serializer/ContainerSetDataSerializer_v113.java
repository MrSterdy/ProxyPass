...
public class ContainerSetDataSerializer_v113 implements BedrockPacketSerializer<ContainerSetDataPacket> {
    public static final ContainerSetDataSerializer_v113 INSTANCE = new ContainerSetDataSerializer_v113();
