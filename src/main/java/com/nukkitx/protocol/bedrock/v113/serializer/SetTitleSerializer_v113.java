...
public class SetTitleSerializer_v113 implements BedrockPacketSerializer<SetTitlePacket> {
    public static final SetTitleSerializer_v113 INSTANCE = new SetTitleSerializer_v113();
