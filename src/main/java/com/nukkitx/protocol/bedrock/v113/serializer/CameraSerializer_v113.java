...
public class CameraSerializer_v113 implements BedrockPacketSerializer<CameraPacket> {
    public static final CameraSerializer_v113 INSTANCE = new CameraSerializer_v113();
