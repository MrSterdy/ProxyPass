...
public class ShowCreditsSerializer_v113 implements BedrockPacketSerializer<ShowCreditsPacket> {
    public static final ShowCreditsSerializer_v113 INSTANCE = new ShowCreditsSerializer_v113();
