...
public class BlockEventSerializer_v113 implements BedrockPacketSerializer<BlockEventPacket> {
    public static final BlockEventSerializer_v113 INSTANCE = new BlockEventSerializer_v113();
