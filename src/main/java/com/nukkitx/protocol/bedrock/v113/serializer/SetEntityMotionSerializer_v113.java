...
public class SetEntityMotionSerializer_v113 implements BedrockPacketSerializer<SetEntityMotionPacket> {
    public static final SetEntityMotionSerializer_v113 INSTANCE = new SetEntityMotionSerializer_v113();
