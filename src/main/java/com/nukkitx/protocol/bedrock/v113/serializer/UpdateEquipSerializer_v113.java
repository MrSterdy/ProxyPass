...
public class UpdateEquipSerializer_v113 implements BedrockPacketSerializer<UpdateEquipPacket> {
    public static final UpdateEquipSerializer_v113 INSTANCE = new UpdateEquipSerializer_v113();
