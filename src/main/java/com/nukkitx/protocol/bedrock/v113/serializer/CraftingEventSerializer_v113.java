...
public class CraftingEventSerializer_v113 implements BedrockPacketSerializer<CraftingEventPacket> {
    public static final CraftingEventSerializer_v113 INSTANCE = new CraftingEventSerializer_v113();
