...
public class AddPaintingSerializer_v113 implements BedrockPacketSerializer<AddPaintingPacket> {
    public static final AddPaintingSerializer_v113 INSTANCE = new AddPaintingSerializer_v113();
