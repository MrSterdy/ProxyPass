...
public class EntityFallSerializer_v113 implements BedrockPacketSerializer<EntityFallPacket> {
    public static final EntityFallSerializer_v113 INSTANCE = new EntityFallSerializer_v113();
