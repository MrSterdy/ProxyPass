...
public class AddEntitySerializer_v113 implements BedrockPacketSerializer<AddEntityPacket> {
    public static final AddEntitySerializer_v113 INSTANCE = new AddEntitySerializer_v113();
