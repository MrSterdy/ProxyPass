...
public class SetEntityDataSerializer_v113 implements BedrockPacketSerializer<SetEntityDataPacket> {
    public static final SetEntityDataSerializer_v113 INSTANCE = new SetEntityDataSerializer_v113();
