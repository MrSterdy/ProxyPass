...
public class MobEquipmentSerializer_v113 implements BedrockPacketSerializer<MobEquipmentPacket> {
    public static final MobEquipmentSerializer_v113 INSTANCE = new MobEquipmentSerializer_v113();
