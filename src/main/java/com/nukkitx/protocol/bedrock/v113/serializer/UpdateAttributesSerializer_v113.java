...
public class UpdateAttributesSerializer_v113 implements BedrockPacketSerializer<UpdateAttributesPacket> {
    public static final UpdateAttributesSerializer_v113 INSTANCE = new UpdateAttributesSerializer_v113();
