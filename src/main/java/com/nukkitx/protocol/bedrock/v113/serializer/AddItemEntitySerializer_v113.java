...
public class AddItemEntitySerializer_v113 implements BedrockPacketSerializer<AddItemEntityPacket> {
    public static final AddItemEntitySerializer_v113 INSTANCE = new AddItemEntitySerializer_v113();
